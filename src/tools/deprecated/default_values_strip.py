...
# ===================================================================
# Purpose:
#   Strip key-values that are default in the game
#   Since JACK/Hammer loves to apply the FGD's default
#   Forcing the map to have a lot of unnecesary data
#   I lost the modified input.json by Sparks. this one lacks key-value definitions.
# ===================================================================
# ===================================================================
