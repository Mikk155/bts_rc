...
class ammo_bts_glocksd_battery : ScriptBasePlayerAmmoEntity,
                                 bts_ammo_base
{
    void Spawn()
    {
...
class ammo_bts_m16sd : ScriptBasePlayerAmmoEntity,
                       bts_ammo_base
{
    void Spawn()
    {
...
class ammo_bts_dummy : ScriptBasePlayerAmmoEntity,
                       bts_ammo_base
{
    void Spawn()
    {
...
class ammo_bts_m16sd_grenade : ScriptBasePlayerAmmoEntity,
                               bts_ammo_base
{
    void Spawn()
    {
...
class ammo_bts_uzisd : ScriptBasePlayerAmmoEntity,
                       bts_ammo_base
{
    void Spawn()
    {
