...
namespace weapon_bts_sw637
{
    ...
    class weapon_bts_sw637 : ScriptBasePlayerWeaponEntity, CBaseWeapon
    {
        ...
        void UpdateViewBodygroups()
        {
            ...
            pev.body = g_ModelFuncs.SetBodygroup( mdl, pev.body, BODYGROUP_HANDS, util::GetClass(m_pPlayer) );
        ...
        void PrimaryAttack()
        {
            ...
            m_pPlayer.pev.punchangle.x = util::IsTrainedPersonal( m_pPlayer ) ? -3.0f : -7.0f;
