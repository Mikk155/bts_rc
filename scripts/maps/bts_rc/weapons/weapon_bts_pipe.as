...
// Models
string W_MODEL = "models/bts_rc/weapons/w_pipe.mdl";
string V_MODEL = "models/bts_rc/weapons/v_pipe.mdl";
string P_MODEL = "models/bts_rc/weapons/p_pipe.mdl";
// Sounds
string MISS_SND = "bts_rc/weapons/pipe_miss1.wav";
