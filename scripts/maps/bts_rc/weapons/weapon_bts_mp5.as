...
namespace weapon_bts_mp5
{
    ...
    class weapon_bts_mp5 : ScriptBasePlayerWeaponEntity, CBaseWeapon
    {
        ...
        bool Deploy()
        {
            return bts_deploy( "models/bts_rc/weapons/v_9mmar.mdl", "models/bts_rc/weapons/p_9mmar.mdl", DRAW, "mp5", 1, 0.6f );
        }
