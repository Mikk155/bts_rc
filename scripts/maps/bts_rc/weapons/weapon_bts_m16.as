...
namespace weapon_bts_m16
{
    ...
    class weapon_bts_m16 : ScriptBasePlayerWeaponEntity, CBaseWeapon
    {
        ...
        void SecondaryAttack()
        {
            ...
            {
                g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_STATIC, "bts_rc/fvox/ammowarning.wav", 1.0, ATTN_NORM );
            }
