...
namespace weapon_bts_sawsd
{
    ...
    class weapon_bts_sawsd : ScriptBasePlayerWeaponEntity, CBaseWeapon
    {
        ...
        bool Deploy()
        {
            return bts_deploy( "models/bts_rc/weapons/v_sawsd.mdl", "models/bts_rc/weapons/p_sawsd.mdl", DRAW, "saw", 1 );
        }
        ...
        void PrimaryAttack()
        {
            ...
            if( g_M249Knockback.GetBool() )
            {
                ...
                m_pPlayer.pev.velocity.z = flZVel * 1.15f;
            }
        }
        ...
        private void FinishAnim()
        {
            ...
            pev.body = g_ModelFuncs.SetBodygroup( g_ModelFuncs.ModelIndex( "models/bts_rc/weapons/v_sawsd.mdl" ), pev.body, 1, player_models::GetClass(m_pPlayer) );
