...
namespace weapon_bts_uzisd
{
    ...
    class weapon_bts_uzisd : ScriptBasePlayerWeaponEntity, CBaseWeapon
    {
        ...
        void Spawn()
        {
            g_EntityFuncs.SetModel( self, self.GetW_Model( "models/bts_rc/weapons/w_uzisd.mdl" ) );
        ...
        void PrimaryAttack()
        {
            ...
            if( player_models::IsTrainedPersonal( m_pPlayer ) )
            {
