...
namespace weapon_bts_glocksd
{
    ...
    class weapon_bts_glocksd : ScriptBasePlayerWeaponEntity, bts_rc_base_weapon
    {
        ...
        bool Deploy()
        {
            ...
            msg.End();
            return bts_deploy( "models/bts_rc/weapons/v_9mmhandgunsd.mdl", "models/bts_rc/weapons/p_9mmhandgunsd.mdl", DRAW, "onehanded", 2, 0.6f);
        }

        void Holster( int skiplocal = 0 )
        {
            SetThink( null );
            g_SoundSystem.StopSound( m_pPlayer.edict(), CHAN_ITEM, "bts_rc/items/battery_reload.wav" );
        ...
        void PrimaryAttack()
        {
            ...
            {
                case 0: g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "bts_rc/weapons/glocksd_fire1.wav", Math.RandomFloat( 0.9f, 1.0f ), ATTN_NORM ); break;
                case 1: g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "bts_rc/weapons/glocksd_fire2.wav", Math.RandomFloat( 0.9f, 1.0f ), ATTN_NORM ); break;
            }
			...
			if (m_kLaserState != 0)
			{
				self.m_flNextPrimaryAttack = g_Engine.time + ( is_trained_personal ? 0.10f : 0.13f );
			}
	  ...
	  private CBaseEntity@ get_m_pLaser() property
	  {
        ...
        private void BaterryRechargeEnd()
        {
            ...
            m_pPlayer.m_rgAmmo( self.m_iSecondaryAmmoType, m_pPlayer.m_rgAmmo( self.m_iSecondaryAmmoType ) - 2 );
