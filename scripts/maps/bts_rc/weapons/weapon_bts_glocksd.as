...
namespace weapon_bts_glocksd
{
    ...
    class weapon_bts_glocksd : ScriptBasePlayerWeaponEntity, CBaseWeapon
    {
        ...
        void PrimaryAttack()
        {
            ...
            {
                case 0:
                    g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "bts_rc/weapons/glocksd_fire1.wav", Math.RandomFloat( 0.9f, 1.0f ), ATTN_NORM );
                    break;
                case 1:
                    g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "bts_rc/weapons/glocksd_fire2.wav", Math.RandomFloat( 0.9f, 1.0f ), ATTN_NORM );
                    break;
            }
