...
class Csentry_laser
{
    ...
    void think()
    {
        ...
        while( ( @entity = g_EntityFuncs.FindEntityByClassname( entity, "monster_sentry" ) ) !is null )
        {
            ...
            NetworkMessage m( MSG_BROADCAST, NetworkMessages::SVC_TEMPENTITY );
                ...
                m.WriteShort( g_ModelFuncs.ModelIndex( CONST_SENTRY_LASER_MODEL ) );
            ...
            CSprite@ sprite = g_EntityFuncs.CreateSprite( CONST_SENTRY_LASER_MODEL2, tr.vecEndPos, true );
